...
export const metadata = {
  ...
  description: 'Privacy policy and data protection terms for Kanishka Travels outstation cab & taxi service in Chennai.',
};
    ...
    <div className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto space-y-10">
      ...
      <div className="card-editorial p-8 sm:p-12 rounded-3xl space-y-8 text-sm text-[#F8F5EE]/80 leading-relaxed font-sans font-light">
        ...
        <section className="space-y-3">
          ...
          <p>
            Booking data stored electronically in our customer portal is secured via Supabase encrypted databases and SSL technology. Access is restricted exclusively to proprietor S. Ramesh for booking fulfillment.
          </p>
        </section>
        ...
        <section className="space-y-3 border-t border-[#D4AF37]/15 pt-6">
          ...
          <div className="font-mono text-xs text-[#F5D77F] space-y-1 pt-1">
            ...
            <p><strong>Email:</strong> support@kanishkatravels.com</p>
