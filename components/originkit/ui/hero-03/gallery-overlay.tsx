...
const A = "/originkit/hero-03";

const TUNNEL_IMAGES = [
  { src: `${A}/portraits-portrait-01.png`, alt: "Editorial portrait" },
  { src: `${A}/portraits-portrait-03.png`, alt: "Studio portrait" },
  { src: `${A}/portraits-portrait-06.png`, alt: "Fashion portrait" },
  { src: `${A}/portraits-portrait-08.png`, alt: "Action portrait" },
  { src: `${A}/portraits-portrait-04.png`, alt: "Lifestyle portrait" },
];
